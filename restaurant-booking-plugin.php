...
class RestaurantBookingPlugin
{
    ...
    private function include_files()
    {
        ...
        // Page de diagnostic AJAX
        if (file_exists(RESTAURANT_BOOKING_PLUGIN_DIR . 'admin/class-ajax-debug-page.php')) {
            require_once RESTAURANT_BOOKING_PLUGIN_DIR . 'admin/class-ajax-debug-page.php';
        }
        
        // Classes utilitaires de test et nettoyage
        if (file_exists(RESTAURANT_BOOKING_PLUGIN_DIR . 'admin/class-test-cleanup.php')) {
            require_once RESTAURANT_BOOKING_PLUGIN_DIR . 'admin/class-test-cleanup.php';
        }
    ...
    public function load_components()
    {
        ...
        if (is_admin()) {
            ...
            // Instancier la page de débogage AJAX
            if (class_exists('RestaurantBooking_Ajax_Debug_Page')) {
                new RestaurantBooking_Ajax_Debug_Page();
            }
    ...
    public function enqueue_public_scripts()
    {
        ...
        // ✅ CORRECTION : Configuration AJAX harmonisée avec le formulaire V3
        $public_config = array(
            'ajax_url' => admin_url('admin-ajax.php'),
            'ajaxUrl' => admin_url('admin-ajax.php'),
            'nonce' => wp_create_nonce('restaurant_booking_form_v3'), // Harmoniser le nonce
            'messages' => array(
        ...
        wp_localize_script('restaurant-booking-public', 'restaurant_booking_ajax', $public_config);
    }
