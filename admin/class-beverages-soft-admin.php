                            ...
                            <div id="beverage_sizes_container">
                                <?php if (!$product): ?>
                                    <div class="notice notice-warning" style="margin-bottom: 15px;">
                                        <p><strong><?php _e('Important :', 'restaurant-booking'); ?></strong> <?php _e('Veuillez d\'abord enregistrer le produit avant d\'ajouter des contenances.', 'restaurant-booking'); ?></p>
                                    </div>
                                <?php endif; ?>
                                ...
                                <button type="button" class="button button-secondary" id="add_size_button" <?php echo !$product ? 'disabled title="' . __('Enregistrez d\'abord le produit pour pouvoir ajouter des contenances', 'restaurant-booking') . '"' : ''; ?>>
