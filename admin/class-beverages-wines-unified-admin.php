                            ...
                            <?php foreach ($wines as $wine) : ?>
                                <tr>
                                    ...
                                    <td class="column-image">
                                        <?php 
                                        $image_url = '';
                                        if (!empty($wine->image_id)) {
                                            $image_url = wp_get_attachment_image_url($wine->image_id, 'thumbnail');
                                        }
                                        ?>
                                        <?php if ($image_url) : ?>
                                            <img src="<?php echo esc_url($image_url); ?>" alt="<?php echo esc_attr($wine->name); ?>" style="width: 50px; height: 50px; object-fit: cover; border-radius: 4px;">
                                        <?php else : ?>
